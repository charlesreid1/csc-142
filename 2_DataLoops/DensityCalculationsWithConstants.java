 ...
 * after converting the units of density. It uses the Java convention for defining
 * class constants to define the conversion factor. 
 *
...
public class DensityCalculationsWithConstants {
    public static void main(String[] args) { 
        ...
        public static double gcm3_to_lbft3 final = 62.427961; // 1 g/cm3 = 62.42 lb/ft3
